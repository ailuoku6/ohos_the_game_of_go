...
export class WeiqiCore {
    ...
    //更新board
    private renderBoard() {
        console.info('-----weiqicore here build', this.render, this.board);
    ...
    public onBoardChange(render: (board: number[][]) => void) {
        ...
        console.info('--------weiqicore onchangeBind',render);
        this.render = render;
    }
